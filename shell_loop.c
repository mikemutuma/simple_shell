...
/**
 * find_builtin - this function checks a builtin cmd
 * @info: arguement and return information structure
 *
 * Return: -1 if builtin empty,
 * 0 if builtin true,
 * 1 if builtin false,
...
/**
 * find_cmd - this function checks cmd in path
 * @info: arguement and return infomation structure
 *
 * Return: void
 */
...
/**
 * fork_cmd - this function forks an execution to run command
 * @info: arguement and  return infomation structure
 *
 * Return: void
 */
